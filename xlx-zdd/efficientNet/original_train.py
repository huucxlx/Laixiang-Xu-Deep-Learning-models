...
def main(args):
    ...
    # 实例化训练数据集
    train_dataset = MyDataSet(images_path="D:\\car-data\\train",
                              images_class=train_images_label,
                              transform=data_transform["train"])

    # 实例化验证数据集
    val_dataset = MyDataSet(images_path="D:\\car-data\\val",
...
if __name__ == '__main__':
    ...
    # 数据集所在根目录
    # https://storage.googleapis.com/download.tensorflow.org/example_images/data.tgz
