...
def parse_opt(known=False):
    ...
    parser.add_argument('--data-path', type=str, default=r"D:\Test11_efficientnetV2 _first\train")
    parser.add_argument('--weights', type=str, default=r'D:\vgg\pre_efficientnetv2-s.pth', help='initial weights path')
