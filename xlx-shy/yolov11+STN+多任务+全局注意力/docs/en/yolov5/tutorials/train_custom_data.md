...
```bash
python train_CDFA.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt
```
...
python train_CDFA.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt  # 3. train
```
...
4. **Train the Model**:
    ```bash
    python train_CDFA.py --img 640 --epochs 3 --data dataset.yaml --weights yolov5s.pt
    ```
